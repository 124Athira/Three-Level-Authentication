...
def talk(user_sentence,model_path):
	print("/////",model_path)
	csv_file_path = "./"+model_path+"/dataset.csv"
    
	tfidf_vectorizer_pikle_path = "./"+model_path+"/tfidf_vectorizer.pickle"
	tfidf_matrix_train_pikle_path = "./"+model_path+"/tfidf_matrix_train.pickle"
